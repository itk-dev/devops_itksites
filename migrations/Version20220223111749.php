 ...
 */
final class Version20220223111749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE server (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by VARCHAR(255) DEFAULT \'\' NOT NULL, modified_by VARCHAR(255) DEFAULT \'\' NOT NULL, api_key VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, hosting_provider_name VARCHAR(255) DEFAULT NULL, internal_ip VARCHAR(15) DEFAULT NULL, external_ip VARCHAR(15) DEFAULT NULL, veeam TINYINT(1) NOT NULL, azure_backup TINYINT(1) NOT NULL, monitoring TINYINT(1) NOT NULL, ssh_user VARCHAR(15) NOT NULL, database_version VARCHAR(5) DEFAULT NULL, ssl_provider VARCHAR(15) NOT NULL, system VARCHAR(15) NOT NULL, note LONGTEXT DEFAULT NULL, service_desk_ticket VARCHAR(255) DEFAULT NULL, used_for VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_5A6DD5F6C912ED9D (api_key), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
