...
use App\Form\Type\Admin\ServerEnvFilter;
...
class ServerCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield ChoiceField::new('env')->setChoices(ServerEnvType::CHOICES)->renderExpanded()->setColumns(6);
